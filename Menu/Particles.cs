    ...
    class Particles
    {
        ...
        public static void Draw()
        {
            if (ControllerInputPoller.instance.rightControllerPrimaryButton)
            {
                ...
                // List of all color combinations (startColor, endColor)
                List<ParticleSystem.MinMaxGradient> gradients = new List<ParticleSystem.MinMaxGradient>
        {
            new ParticleSystem.MinMaxGradient(new Color(0.4f, 0.7f, 1f), new Color(0.9f, 0.4f, 1f)), // original (blue-purple)
            new ParticleSystem.MinMaxGradient(new Color(1f, 0.3f, 0.2f), new Color(1f, 0.6f, 0f)),   // fire
            new ParticleSystem.MinMaxGradient(new Color(1f, 1f, 0.3f), new Color(0.2f, 0.6f, 1f)),   // electric
            new ParticleSystem.MinMaxGradient(new Color(0.6f, 0.9f, 1f), new Color(1f, 1f, 1f)),     // ice
            new ParticleSystem.MinMaxGradient(new Color(0.5f, 0f, 0.7f), new Color(0f, 0f, 0f)),     // void
        };

                // Pick a random color combo each time
                mainModule.startColor = gradients[UnityEngine.Random.Range(0, gradients.Count)];
                ...
                UnityEngine.Object.Destroy(rasenganSpell, 5f);
            }
        }
